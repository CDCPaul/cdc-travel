...
export default function EditProductPage() {
  ...
  // 포함/불포함 항목 관리 함수들
  const addArrayItem = (field: 'included' | 'notIncluded', value: string) => {
    setFormData(prev => ({
      ...prev,
  ...
  const updateArrayItem = (field: 'included' | 'notIncluded', index: number, value: string) => {
    setFormData(prev => ({
      ...prev,
  ...
  return (
    <div className="p-6">
      <Link href="/admin/products" className="text-blue-600 hover:text-blue-800 mb-4 inline-block">
        {texts.backToList}
      </Link>
            ...
            {formData.included.map((item, index) => (
              <div key={index} className="flex gap-2 mb-2">
                <input
                  ...
                  placeholder={texts.includedPlaceholder}
            ...
            {formData.notIncluded.map((item, index) => (
              <div key={index} className="flex gap-2 mb-2">
                <input
                  ...
                  placeholder={texts.notIncludedPlaceholder}
                  className="flex-1 p-2 border rounded"
                />
                <button
                  type="button"
