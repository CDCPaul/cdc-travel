        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {products.map((product) => (
            <div key={product.id} className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-4">
                <h3 className="text-lg font-semibold mb-2">{product.title?.[lang] || '제목 없음'}</h3>
                ...
                <div className="flex gap-2">
                  <Link
                    ...
                    className="flex-1 px-3 py-2 bg-blue-500 text-white rounded text-sm hover:bg-blue-600 text-center"
                  >
                    {texts.editButton}
                  </Link>
                  <button
