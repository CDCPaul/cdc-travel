...
const missingEnvVars = requiredEnvVars.filter(varName => typeof process.env[varName] === 'undefined' || process.env[varName] === '');
...
console.log('Firebase env values:', {
  ...
  bucket: process.env.NEXT_PUBLIC_FIREBASE_BUCKET,
});
